...
INSERT INTO roles(description,name) values ('SuperAdmin', 'SUPERADMIN');
...
INSERT INTO users (email,first_name, last_name,password,username) values ('superadmin@gmail.com','superadmin', 'superadmin','$2a$04$EZzbSqieYfe/nFWfBWt2KeCdyq0UuDEM1ycFF8HzmlVR6sbsOnw7u','superadmin');
